...
public class BankerDemo {
    public static void main(String[] args) throws Exception {
        ...
        DemirBank nursultanDemirBankAccount = new DemirBank(118000012341l, 123456789);
        ...
        System.out.println("Nursultan's balnce after transfer is: " + nursultanDemirBankAccount.getBalance());
